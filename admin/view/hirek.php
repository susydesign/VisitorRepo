...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="session">
            <h1 id="sess_cim">Hírek oldal</h1>
            <p id="sess_desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit mollitia ut ullam incidunt. Quibusdam, reprehenderit esse dignissimos deserunt molestiae sequi suscipit illum ipsum repellendus, eligendi optio quasi! Accusamus modi esse cupiditate reiciendis autem voluptatum ut odit aliquid, aut expedita facilis distinctio doloremque dolore aperiam voluptatem, alias laboriosam saepe ab, a laborum consectetur dignissimos assumenda. Dicta enim provident nihil deserunt voluptate numquam obcaecati nesciunt? Et itaque ad quo ut accusamus explicabo voluptas quibusdam non sit quod similique natus temporibus, qui dolores provident harum officiis eos porro voluptatem dolorum nam ipsa tenetur, nihil minus! Architecto dolorem asperiores ipsa a magnam possimus autem!</p>
            <div id="sess_torzs">
                <div id=urlap>
                    <form>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="h_cim">Hírek címe</span>
                            <input type="text" class="form-control" placeholder="Pl.: Új szobák átadása" aria-label="h_cim" aria-describedby="h_cim">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="h_kategoria">Kategória</span>
                            <input type="text" class="form-control" placeholder="Otthon hírek" aria-label="h_kategoria" aria-describedby="h_kategoria">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="h_tartalom">Tartalom</span>
                            <input type="text" class="form-control" placeholder="Cikk szövege" aria-label="h_tartalom" aria-describedby="h_tartalom">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="h_kep">Kép</span>
                            <input type="text" class="form-control" placeholder="A cikkhez tartozó kép feltöltése" aria-label="h_kep" aria-describedby="h_kep">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="h_video">Videó</span>
                            <input type="text" class="form-control" placeholder="A cikkhez tartozó videó feltöltése" aria-label="h_video" aria-describedby="h_video">
                        </div>
