                ...
                <div id=urlap>
                    <form>
                        ...
                        <div class="input-group flex-nowrap p-3">
                            ...
                            <input type="text" class="form-control" placeholder="pl: 2553" aria-label="o_irsz" aria-describedby="o_irsz">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="o_varos">Város</span>
                            <input type="text" class="form-control" placeholder="pl: Szolnok" aria-label="o_varos" aria-describedby="o_varos">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="o_utca">Utca, hsz</span>
                            <input type="text" class="form-control" placeholder="pl.:Kossuth Lajos utca 15/b" aria-label="o_utca" aria-describedby="o_utca">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="o_telefon">Telefonszám</span>
                            <input type="text" class="form-control" placeholder="pl.: +36 (30) 1234567" aria-label="o_telefon" aria-describedby="o_telefon">
                        </div>
                        <div class="input-group flex-nowrap p-3">
                            <span class="input-group-text w-25" id="o_email">E-mail cím</span>
                            <input type="text" class="form-control" placeholder="pl.: info@idosotthon.hu" aria-label="o_email" aria-describedby="o_email">
                        </div>
