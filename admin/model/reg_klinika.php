...
$sql_in = "INSERT INTO klinika (klinika_nev,k_address_irsz,k_address_varos,k_address_utca,k_address_hsz,k_phone,k_mobil,k_email,k_web,k_logo,k_rolunk,geoframe) 
            VALUES (:klinika_nev,:k_address_irsz,:k_address_varos,:k_address_utca,:k_address_hsz,:k_phone,:k_mobil,:k_email,:k_web,:k_logo,:k_rolunk,:geoframe)";
...
$result_in->bindParam(':k_email', $k_email);
