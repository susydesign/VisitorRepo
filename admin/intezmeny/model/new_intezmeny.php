...
$sql_in = "INSERT INTO intezmeny (i_nev,i_irsz,i_varos,i_utca,i_hsz,i_telefon,i_email,i_kapcs,i_rolunk) 
            VALUES (:i_nev,:i_irsz,:i_varos,:i_utca,:i_hsz,:i_telefon,:i_email,:i_kapcs,:i_rolunk)";
